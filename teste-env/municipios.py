...
if __name__ == '__main__':
    ...
    Municipios = (jmanager.read_json('data/data.json')['estados'])

    aleatorio = random.choice(Municipios)
    print(aleatorio)

# -------------------------------------------------------------------------------------------
# REQUEST DA API

resposta = requests.get('https://brasilapi.com.br/api/ibge/municipios/v1/' + f'{aleatorio}')
